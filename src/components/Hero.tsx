      ...
      <div className="container mx-auto px-6 lg:px-12 text-center relative z-10 max-w-5xl flex flex-col justify-center min-h-screen py-20">
        ...
        <div className="mb-12 lg:mb-16 smooth-reveal">
          <img 
            ...
            alt="GridShift" 
            className="w-[60px] md:w-[100px] lg:w-[160px] xl:w-[220px] mx-auto opacity-95 hover:opacity-100 transition-all duration-500 translate-y-0"
            style={{ height: 'auto', transform: 'translateY(6%)' }}
          />
        </div>
